        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 p-6 md:p-8">
            ...
            <div className="w-full px-4">
              <div className="grid lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex justify-end">
              <button
                type="button"
                disabled={isLoader}
                className={`px-6 py-2 mt-3 bg-[#AB6545] text-white rounded-md hover:bg-[#050708] transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
