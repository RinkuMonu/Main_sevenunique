...
export default function Banner2({ slides, autoplay = true, interval = 5000 }: BannerProps) {
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="container mx-auto px-4 text-center text-white">
              ...
              >
               {/* <h1 style={{fontSize: "40px", width: "50%", marginTop: "65px", lineHeight:"50px"}}> {slides[current].title} </h1> */}
              </motion.h1>
              <motion.p
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
