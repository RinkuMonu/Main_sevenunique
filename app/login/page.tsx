    ...
    <div className="container-fluid p-0 h-screen bg-gray-100">
      <div className="h-full">
        <div className="flex flex-row h-full">
          ...
          <div className="w-full md:w-1/2 py-5 px-2 md:pe-5">
            <div className="ps-2 max-w-md mx-auto">
              <div className="mt-5">
                ...
                <div className="space-y-4">
                  <div className="mb-3">
                    ...
                    {!showOtpField && (
                      <button
                        type="button"
                        className="w-full mt-3 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50"
                        onClick={sendOtp}
                        disabled={loading}
                      >
