        ...
        <div className="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-start gap-8">
          <div className="w-full md:w-1/2 mb-8 md:mb-0">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Lowest payment gateway<br />
              charges in India
            </h1>
            <p className="text-purple-200 text-lg max-w-lg">
              Competitive rates with no hidden fees and complete transparency
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 text-gray-800">
              ...
              <p className="text-xs text-gray-500 mt-3">
                *Pricing for Payment Gateway only. See for other{" "}
                <button className="text-green-500 font-medium hover:underline">products</button>
              </p>
            </div>

            <div className="bg-purple-900 rounded-xl p-6 text-white">
              <p className="text-purple-300 text-xs font-semibold uppercase tracking-wider mb-2">Enterprises</p>
        ...
        <div className="hidden md:block w-64 bg-white border-r border-gray-200 min-h-screen fixed left-0 top-0 z-10">
          <div className="p-6">
            ...
            <nav className="space-y-1">
              <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-3">Collect Payments</div>
              {[
              ...
              <div className="text-xs font-medium text-gray-500 uppercase tracking-wider mt-8 mb-3">Make Payouts</div>
          ...
          <section className="container mx-auto px-6 py-12">
            <div className="bg-white rounded-xl shadow-sm p-8 mb-10">
              <div className="flex items-center mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Accept payments in Indian Rupees (INR) and other 100+ foreign currencies
                  </p>
                </div>
              </div>
                ...
                <div className="p-6 border-t">
                  <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 mb-6 md:mb-0">
                      {["UPI", "Visa", "Mastercard", "RuPay", "PhonePe"].map((item, i) => (
                        <div key={i} className="flex flex-col items-center">
                          ...
                          <span className="text-xs text-center font-medium">{item}</span>
                        </div>
                      ))}
                    </div>
                    <div className="text-right">
                      <p className="line-through text-gray-500 text-sm">2%</p>
                      <p className="text-purple-700 text-2xl font-bold">1.95%</p>
                ...
                <div key={i} className="border rounded-xl mb-4 overflow-hidden">
                  <div className="bg-gray-50 px-6 py-4 flex justify-between items-center cursor-pointer hover:bg-gray-100 transition-colors">
                    ...
                    <div className="flex items-center">
                      <span className="text-gray-500 text-sm mr-2">Starting at</span>
                      {item.oldRate && <span className="text-gray-500 text-sm line-through mr-2">{item.oldRate}</span>}
                      <span className="text-purple-700 font-semibold mr-3">{item.rate}</span>
              ...
              <p className="text-xs text-gray-500 mt-6">
                * Platform fee shall be a fee paid by the Merchant for services such as Hosted Checkout, Plugins, SDKs,
                Dashboard, and Generation of Reports. The Platform Fee shall be calculated on either total transactions
                or a certain number of transactions or a certain percentage of transactions of the total transaction as
            ...
            <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-xl p-8 mb-10 text-white">
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-2/3 mb-8 md:mb-0">
                  <h3 className="text-xl font-bold mb-3">3 Products free with our PG!</h3>
                  <p className="text-purple-100">
                    Use our <span className="font-semibold">Payment Links, Payment Forms,</span> and{" "}
                    <span className="font-semibold">softPOS</span> products to collect payments wherever your customers are
            ...
            <div className="bg-purple-900 rounded-xl p-8 mb-10 text-white">
              <div className="flex flex-col md:flex-row gap-8">
                <div className="md:w-1/3">
                  <h3 className="text-xl font-bold mb-3">Avail exclusive access to our premium services</h3>
                  <p className="text-purple-300 text-sm">with an annual maintenance charge</p>
                </div>
                    ...
                    {[
                      ...
                      <div key={i} className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-purple-300 text-sm mt-1">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <div className="mb-12">
              <h3 className="text-xl font-bold mb-8">Already using payment gateway?</h3>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="border-b border-gray-200 pb-4">
                    ...
                    {item.open && <p className="mt-3 text-gray-600">{item.a}</p>}
                  </div>
                ))}
              </div>
            ...
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-purple-100 mb-8 max-w-3xl mx-auto">
                  Collect customer payments, make payouts, manage international payments and so much more. Create your
                  account or contact our experts to explore custom solutions.
                </p>
