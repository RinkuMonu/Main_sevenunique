...
export default function GameDevelopmentPage() {
  ...
  return (
    <div className="">
      ...
      {/* CTA Section */}
      <section className="py-16 md:py-24 md:px-24 bg-gary-50 text-white"   style={{backgroundImage:"url(/image/15031301.jpg)",   backgroundRepeat:"no-repeat", backgroundAttachment:"fixed", backgroundPosition:"bottom", backgroundSize:"cover"}}>
