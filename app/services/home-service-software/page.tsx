...
export default function HomeServiceSoftwarePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 px-24 bg-primary text-white"   style={{backgroundImage:"url(/image/6645.jpg)", backgroundPosition:"center", backgroundRepeat:"no-repeat", backgroundAttachment:"fixed"}}>
        <div className="px-4 md:px-6">
