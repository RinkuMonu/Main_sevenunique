...
export default function EmployTrackingSoftwarePage() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 md:px-24 text-white"  style={{backgroundImage:"url(/image/254275.jpg)",   backgroundRepeat:"no-repeat", backgroundAttachment:"fixed", backgroundPosition:"bottom", backgroundSize:"cover"}}>
        <div className="px-4 md:px-6">
