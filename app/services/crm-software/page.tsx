...
export default function CRMSoftwarePage() {
    ...
    const bannerSlides = [
        {
          ...
          title: "Transform Your Customer Interactions With A Powerful CRM Solution That Enhances Engagement And Drives Results",
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            ...
            <div className="relative aspect-video overflow-hidden rounded-xl lg:aspect-square">
              <Image src="/image/2150038421 (1).jpg" alt="CRM Software" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="relative aspect-video overflow-hidden rounded-xl lg:aspect-square order-2 lg:order-1">
              <Image src="/image/5831.jpg" alt="CRM Dashboard" fill className="object-cover" />
            </div>
      ...
      <section className="py-16 md:py-24 md:px-24 bg-[#AB6545] text-white"  style={{backgroundImage:"url(/image/685359.jpg)",  backgroundRepeat:"no-repeat", backgroundAttachment:"fixed", backgroundPosition:"bottom", backgroundSize:"cover"}}>
        <div className="px-4 md:px-6">
